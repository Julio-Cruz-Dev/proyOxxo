 ...
 * 
 */
@WebServiceClient(name = "WSTelefonia", targetNamespace = "http://service/", wsdlLocation = "http://localhost:8090/WSTelefonia/WSTelefonia?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8090/WSTelefonia/WSTelefonia?wsdl");
